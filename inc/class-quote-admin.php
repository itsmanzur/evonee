...
class Evonee_Quote_Admin {
    ...
    public static function get_settings() {
        $defaults = [
            ...
            'enable_discord'           => '0',
            'discord_webhook_url'      => '',
            // Phase 5 Enterprise Settings
            'enable_auto_quoter'       => '0',
            'auto_quoter_min_qty'      => 100,
            'auto_quoter_unit_price'   => 2.50,
            'enable_call_booking'      => '1',
            'enable_twilio_sms'        => '0',
            'twilio_sid'               => '',
            'twilio_token'             => '',
            'twilio_from_number'       => '',
    ...
    public function render_settings_page() {
        if (isset($_POST['eq_save_settings']) && current_user_can('manage_options') && check_admin_referer('eq_save_settings_nonce')) {
            $new_settings = [
                ...
                // Phase 5 Enterprise Settings
                'enable_auto_quoter'       => isset($_POST['enable_auto_quoter']) ? '1' : '0',
                'auto_quoter_min_qty'      => intval($_POST['auto_quoter_min_qty'] ?? 100),
                'auto_quoter_unit_price'   => floatval($_POST['auto_quoter_unit_price'] ?? 2.50),
                'enable_call_booking'      => isset($_POST['enable_call_booking']) ? '1' : '0',
                'enable_twilio_sms'        => isset($_POST['enable_twilio_sms']) ? '1' : '0',
