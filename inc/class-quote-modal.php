...
class Evonee_Quote_Modal {
    ...
    public function render_modal() {
        ...
        <?php if (!isset($settings['enable_global_floating_btn']) || $settings['enable_global_floating_btn'] === '1'): 
            $floating_label = !empty($settings['global_floating_btn_text']) ? $settings['global_floating_btn_text'] : '💬 Request Free Quote';
        ?>
            <button type="button" class="eq-trigger eq-global-float-btn" data-product="" style="position:fixed; bottom:25px; left:25px; z-index:99990; background:linear-gradient(135deg, #6d28d9 0%, #4c1d95 100%); color:#ffffff; border:none; padding:12px 20px; border-radius:30px; font-weight:700; font-size:14px; box-shadow:0 8px 20px rgba(109,40,217,0.35); cursor:pointer; display:flex; align-items:center; gap:8px; transition:transform 0.2s ease;">
                <?php echo esc_html($floating_label); ?>
            </button>
        <?php endif; ?>
